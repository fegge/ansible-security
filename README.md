...
- `locale`: Needed to set locale information on Ubuntu. May Ubuntu VPS have the issue of incorrectly set locale information. If `en_GB.UTF-8` works for you, then you don't need to change anything.
